...
const updatePlan = validateRequest(
  Joi.object({
...
const getSubscriptions = validateQuery(
  Joi.object({
    page: Joi.number().min(1).optional(),
    limit: Joi.number().min(1).max(100).optional(),
    status: Joi.string()
      .valid("trial", "active", "past_due", "canceled", "unpaid", "lifetime")
      .optional(),
...
const updateUserSubscription = validateRequest(
  Joi.object({
    plan_id: mongoId.optional(),
    status: Joi.string()
      .valid("trial", "active", "past_due", "canceled", "unpaid", "lifetime")
...
const createCheckout = validateRequest(
  Joi.object({
...
const getAllUsers = validateQuery(
 ...
 const createUserSchema = Joi.object({
  ...
  user_type: Joi.string().valid("user", "admin", "super_admin").default("user"),
...
export const updateUserSchema = Joi.object({
  ...
  stripe_customer_id: Joi.string().allow(null, "").optional(),
});

...
// ============================================
// MODIFIED FUNCTION - ADD 3RD PARAMETER
// ============================================
export async function generateDetailedInsight(
  grokInsight, 
  analysisParams,
  refinementContext = null  // ← NEW PARAMETER
) {
  try {
...
- Output Detail Level: **${outputDetail}**`;
    ...
    // ← NEW: Add refinement context section if provided
...
${grokInsight}`;
    ...
    // ← NEW: Add refinement context to user prompt if provided

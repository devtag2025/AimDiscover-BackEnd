...
// router.post('/users', authorize(['admin', 'super_admin']),validate.createUserSchema,authController.createUser);
// router.put('/user/:userId' , authorize(['admin', 'super_admin']),validate.updateUserSchema,authController.updateUser);
